...
import 'shared_element/product_list.dart';

final List<String> titleAssets = [
  'assets/icons/food01.jpeg',
  'assets/icons/food02.jpeg',
  'assets/icons/food03.jpeg',
];

final List<ProductItem> _products = [
  ProductItem(
    name: 'Bueno Chocolate',
    asset: 'assets/icons/food01.jpeg',
  ),
  ProductItem(
    name: 'Chocolate with berries',
    asset: 'assets/icons/food02.jpeg',
  ),
  ProductItem(
    name: 'Trumoo Candies',
    asset: 'assets/icons/food03.jpeg',
  ),
  ProductItem(
    name: 'Choco-coko',
    asset: 'assets/icons/food04.jpeg',
  ),
  ProductItem(
    name: 'Chocolate tree',
    asset: 'assets/icons/food05.jpeg',
  ),
  ProductItem(
    name: 'Chocolate',
    asset: 'assets/icons/food06.jpeg',
  ),
  ProductItem(
    name: 'Bueno Chocolate',
    asset: 'assets/icons/food01.jpeg',
